    ...
    <div class="min-h-screen bg-[#001122] flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="w-full max-w-md relative">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-light tracking-wider font-['Orbitron'] relative">
                    <span class="relative inline-block">
                        <span class="relative z-10">
                            ...
                            <span class="text-[#FF00FF]">Reset</span>
                        </span>
                ...
                <p class="mt-2 text-[#00FFFF]/60 text-sm uppercase tracking-[0.2em]">Access Key Configuration</p>
            ...
            <div class="relative bg-[#001122]/95 backdrop-blur-xl border border-[#00FFFF]/20 rounded-lg p-8 shadow-[0_0_50px_rgba(0,255,255,0.1)]">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        <!-- New Password -->
                        <div>
                            <label class="block text-[#00FFFF]/80 text-sm mb-2">NEW ACCESS KEY</label>
                            <div class="relative">
                                <input
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label class="block text-[#00FFFF]/80 text-sm mb-2">VERIFY ACCESS KEY</label>
                            <div class="relative">
                                <input
                    ...
                    <div class="flex justify-end pt-2">
                        ...
                        >
                            <span class="relative z-10">INITIALIZE NEW KEY</span>
